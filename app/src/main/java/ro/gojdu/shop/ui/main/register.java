...
public class register extends AppCompatActivity {
    ...
    EditText etMail,etPassword,etName,etRenter;
    Button btnRegister;
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else
                {
                    ...
                    {
                        Toast.makeText(register.this, "Please make sure that your password and re-type password are the same!", Toast.LENGTH_SHORT).show();
                    }
                }
